...
SYSTEM_PROMPT = (
    ...
    "\n\n"
    "Use generate_image whenever the user wants to see, find, or generate a picture/photo/image of "
    "something — a device already at home, a product they're considering, or anything else. If it's a "
